...
class Margin3DASR(DQN3DASR, MarginBase):
    def __init__(self, workspace, heightmap_size, device, lr=1e-4, gamma=0.9, sl=False, num_primitives=1,
                 ...
                 softmax_beta=100,num_classes=0):
        DQN3DASR.__init__(self, workspace, heightmap_size, device, lr, gamma, sl, num_primitives, patch_size, num_rz, rz_range,num_classes=num_classes)
