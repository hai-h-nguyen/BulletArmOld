...
training_group.add_argument('--lr', type=float, default=5e-5, help='The learning rate')
...
training_group.add_argument('--target_update_freq', type=int, default=500, help='The frequency of updating the target network')
...
training_group.add_argument('--planner_episode', type=int, default=300, help='The number of demonstration episodes to gather before training')
...
training_group.add_argument('--pre_train_step', type=int, default=200, help='The number of pre-training steps')
