...
CUDA_VISIBLE_DEVICES=3 python bulletarm_baselines/fc_dqn/scripts/main_goal.py\
 --algorithm=dqn --architecture=equi_asr --env=1l2b2r --fill_buffer_deconstruct\
 --planner_episode=15 --max_train_step=10000 --wandb_group=sup_goal_15_final --device_name=cuda\
 --wandb_logs=1 --use_classifier=1 --get_bad_pred=0 --seed=3 --classifier_name=equi\
...
# -----------train classifier -------------- #
# CUDA_VISIBLE_DEVICES=2 python bulletarm_baselines/fc_dqn/scripts/State_abstractor.py
