...
CUDA_VISIBLE_DEVICES=0 python bulletarm_baselines/fc_dqn/scripts/main_goal.py\
 ...
 --planner_episode=5 --max_train_step=10000 --wandb_group=goal_5_final --device_name=cuda\
 --wandb_logs=1 --use_classifier=1 --get_bad_pred=0 --seed=4 --classifier_name=normal\
